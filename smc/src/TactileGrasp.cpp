...
const double TOUCH_TRESHHOLD=2; //2
const double speedv = 8;
const double speedo	= -8;
const int STORE_AVG = 10;
const int REF_SPEED_ACC = 15;
...
int main(int argc, char *argv[])
{
	...
	printf("Collecting comparison data from skin\n");
	...
	printf("Data collected, ready to start grasping\n");
	Time::delay(0.5);
